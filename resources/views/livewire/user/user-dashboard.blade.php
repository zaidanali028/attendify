<div class="p-4 sm:p-6 mb-1">
    ...
    @if($todayAttendance)
        <div class="mb-6 bg-white shadow rounded-lg p-6 mb-1">
    ...
    <!-- Analytics Cards -->
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-1">
        <!-- Total Hours -->
        <div class="bg-white shadow rounded-lg p-6 mb-1">
            <div class="flex items-center">
                <div class="flex-shrink-0 bg-indigo-100 rounded-md p-6">
        ...
        <div class="bg-white shadow rounded-lg p-6 mb-1">
            <div class="flex items-center">
                <div class="flex-shrink-0 bg-yellow-100 rounded-md p-6">
        ...
        <div class="bg-white shadow rounded-lg p-6 mb-1">
            <div class="flex items-center">
                <div class="flex-shrink-0 bg-red-100 rounded-md p-6">
        ...
        <div class="bg-white shadow rounded-lg p-6 mb-1">
            <div class="flex items-center">
                <div class="flex-shrink-0 bg-green-100 rounded-md p-6">
        ...
        <div class="bg-white shadow rounded-lg p-6 mb-1">
            <div class="flex items-center">
                <div class="flex-shrink-0 bg-purple-100 rounded-md p-6">
        ...
        <div class="bg-white shadow rounded-lg p-6 mb-1">
            <div class="flex items-center">
                <div class="flex-shrink-0 bg-blue-100 rounded-md p-6">
